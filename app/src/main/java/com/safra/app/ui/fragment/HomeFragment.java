...
// 🆕 Import the new MapActivity
import com.safra.app.ui.activity.MapActivity;
// 🆕 Import the new UserManualActivity
import com.safra.app.ui.activity.UserManualActivity;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // 🆕 NEW: Listener for the Safe Map card
        binding.cardSafeMap.setOnClickListener(v -> {
            Intent intent = new Intent(requireContext(), MapActivity.class);
            startActivity(intent);
        });

        // ✅ Existing Listeners for the grid buttons
        ...
        // 🆕 NEW: Listener for the User Manual card
        binding.cardUserManual.setOnClickListener(v -> {
            // Launch the UserManualActivity using an Intent
            Intent intent = new Intent(getActivity(), UserManualActivity.class);
            startActivity(intent);
        });

        // ... rest of the onCreateView content ...
